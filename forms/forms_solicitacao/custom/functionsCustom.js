...
function createZoom(displayKey,dataset,tamanho,texto,filtro,campos,elemento){
	var zoomElements = "{"+
		"'displayKey':'"+displayKey+"',"+
		"'datasetId':'"+dataset+"',"+
		"'maximumSelectionLength':'"+tamanho+"',"+
		"'placeholder':'"+texto+"',"+
		"'filterValues':'"+filtro+"',"+
		"'fields':"+campos+
	"}"
	$(elemento).attr('data-zoom',zoomElements)
}
...
function hideBlockDivs(divVisivel) {
	...
	for (i = 0; i < DIVS.length; i++) {
		...
		// $('#' + DIVS[i] + ' [role="combobox"]').prop("style", "background-color:#f2f2f2")
